...
注意：本项目仍在持续开发中，目前有些功能尚未完善。

本项目是一个基于 FastAPI 和 Vue 3 构建的前后端分离的智能客服助手项目，支持多种大语言模型，如DeepSeek V3，Qwen2.5系列，Llama3系列等。涵盖了 Agent、RAG 在智能客服领域的主流应用落地需求场景。 
...
# 另外别忘了开启ollama服务，否则会无法正常使用（此时向大模型提问，会报错“生成回复时出错: Cannot connect to host localhost:11434 ssl:default [Multiple exceptions: [Errno 10061] Connect call failed (‘::1’, 11434, 0, 0), [Errno 10061] Connect call failed (‘127.0.0.1’, 11434)]）
```
